...
#  password.
#  Default: ''
# c.ServerApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$L4RIKEpTCIvXu6unW8D+ug$YxsLDfVf4KrrFBOYrVgjN2PiPxyij3m6B+1N0pOu6TA'
...
#  Choices: any of ['blake2b', 'sha3_384', 'blake2s', 'sha3_512', 'sha224', 'sha3_256', 'sha256', 'md5', 'sha3_224', 'sha384', 'sha512', 'sha1']
#  Default: 'sha256'
